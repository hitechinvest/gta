...
vaz2109: {
  ...
  // Иномарки: модели Quaternius Cars (CC0). Габариты заданы в метрах, модель
  // подгоняется под них — физика и картинка всегда совпадают.
  sedanIm: {
    id: 'sedanIm', name: 'Седан', size: [1.81, 1.44, 4.35], mass: 1.15,
    maxSpeed: 42, accel: 17, brake: 29, grip: 5.8, steer: 0.94, health: 115,
    colors: [0xe8e6e0, 0x1f2a33, 0x8a9aa5, 0x2b4c7e, 0x9a2f2f, 0x2f6b45],
    seats: 5, body: 'sedan', foreign: true,
  },
  hatchIm: {
    id: 'hatchIm', name: 'Хэтчбек', size: [1.76, 1.46, 4.1], mass: 1.0,
    maxSpeed: 40, accel: 18, brake: 30, grip: 6.0, steer: 1.02, health: 105,
    colors: [0xd94a3a, 0xe8e6e0, 0x2a3b4a, 0x6b7d8a, 0x1a1a1e, 0x7fa8d0],
    seats: 5, body: 'hatch', foreign: true,
  },
  sportIm: {
    id: 'sportIm', name: 'Спорт-седан', size: [1.84, 1.36, 4.55], mass: 1.1,
    maxSpeed: 48, accel: 22, brake: 33, grip: 6.6, steer: 1.0, health: 110,
    colors: [0x1a1a1e, 0xd94a3a, 0xe0d24a, 0xb0b6ba, 0x2b4c7e],
    seats: 4, body: 'sedan', foreign: true,
  },
  coupeIm: {
    id: 'coupeIm', name: 'Купе', size: [1.82, 1.34, 4.4], mass: 1.05,
    maxSpeed: 50, accel: 23, brake: 34, grip: 6.8, steer: 1.04, health: 100,
    colors: [0xe8e6e0, 0x1a1a1e, 0xd94a3a, 0x6b7d8a],
    seats: 4, body: 'sedan', foreign: true,
  },
  crossIm: {
    id: 'crossIm', name: 'Кроссовер', size: [1.9, 1.74, 4.6], mass: 1.3,
    maxSpeed: 38, accel: 16, brake: 27, grip: 6.2, steer: 0.96, health: 145,
    colors: [0xb9bfc0, 0x2f4a3a, 0x1f2a33, 0xd6d0c0, 0x8a5a2a],
    seats: 5, body: 'suv', foreign: true,
  },
  taxiIm: {
    id: 'taxiIm', name: 'Такси', size: [1.81, 1.46, 4.35], mass: 1.15,
...
// Ходовые модели встречаются на улице чаще прочих, поэтому идут дважды.
const DOMESTIC_CARS = [
  'zhiguli', 'zhiguli', 'vaz2109', 'vaz2109', 'priora', 'priora', 'vesta',
  'largus', 'moskvich', 'zaporozhets', 'volga', 'niva', 'uazPatriot',
  'bukhanka', 'gazelle', 'sobol', 'kamaz', 'paz',
];

const FOREIGN_CARS = ['sedanIm', 'hatchIm', 'sportIm', 'coupeIm', 'crossIm', 'taxiIm'];

/**
 * Из этого списка случайно выбираются машины на улицах. Доли заданы
 * повторами: шесть иномарок по семь записей против восемнадцати наших
 * по одной — ровно 70 на 30.
 */
